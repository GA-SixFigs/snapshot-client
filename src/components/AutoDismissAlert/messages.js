export default {
  ...
  privacyChangeSuccess: 'Privacy settings were changed. Please ensure your settings are correct according to your privacy preference',
  privacyChangeFailure: 'Privacy settings WERE NOT changed.'
}
